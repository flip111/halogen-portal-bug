...
let overrides =
      { halogen-portal =
        ...
        , version = "main"
        -- , version = "588758940f3e619f2236ccdf78a4340cda2218eb"
        , dependencies =
          [ "aff"
          , "avar"
          , "console"
      ...
      , halogen-store = ./purescript-halogen-store_old_fork/spago.dhall as Location
      -- , halogen-store = ./purescript-halogen-store_new_fork/spago.dhall as Location
      }
