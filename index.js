(() => {
  ...
  var Aff = function() {
        ...
        return function() {
          ...
          switch (status2) {
            ...
            case PENDING:
              ...
              if (bracketCount === 0) {
                if (status2 === PENDING) {
                  attempts = new Aff2(CONS, new Aff2(FINALIZER, step3(error6)), attempts, interrupt);
                }
                status2 = RETURN;
                step3 = null;
                fail2 = null;
    ...
    function runPar(util, supervisor, par, cb) {
      ...
      var interrupt = null;
      var root = EMPTY;
      function kill3(error6, par2, cb2) {
        var step3 = par2;
        var head2 = null;
        var tail = null;
        var count = 0;
            ...
            switch (head2.tag) {
              ...
              case APPLY:
                ...
                if (fail2) {
                  ...
                  tmp = true;
                  kid = killId++;
                  kills[kid] = kill3(early, fail2 === lhs ? head2._2 : head2._1, function() {
                    return function() {
                      delete kills[kid];
                      if (tmp) {
                        tmp = false;
              ...
              case ALT:
                ...
                if (lhs !== EMPTY && util.isLeft(lhs) && rhs !== EMPTY && util.isLeft(rhs)) {
                  ...
                  tmp = true;
                  kid = killId++;
                  kills[kid] = kill3(early, step3 === lhs ? head2._2 : head2._1, function() {
                    return function() {
                      delete kills[kid];
                      if (tmp) {
                        tmp = false;
      ...
      function cancel(error6, cb2) {
        ...
        kills = null;
        var newKills = kill3(error6, root, cb2);
    ...
    map: function(v) {
      return function(v1) {
        if (v1 instanceof Handler) {
          return new Handler(v1.value0, map10(map13(v))(v1.value1));
        }
        ;
        if (v1 instanceof Ref) {
          return new Ref(map10(map13(v))(v1.value0));
        }
        ;
        return v1;
      };
  ...
  var substFree = function(k) {
    var go2 = function(f) {
      ...
      if (v instanceof Bind) {
        return bind3(k(v.value0))(map15(go2)(v.value1));
      }
      ;
  ...
  var monadStoreStoreT = function(dictMonadEffect) {
    ...
    return {
      ...
      emitSelected: function(v) {
          ...
          return function(predicate) {
            return makeEmitter(function(k) {
              return emitter(function(a2) {
                return bind6(predicate(a2))(traverse_4(k));
              });
            });
          };
        };
        return bind22(ask2)(function(store) {
          return liftEffect22(function __do3() {
            var init2 = read(store.value)();
            var prevRef = $$new(v.select(init2))();
            return filterEmitter(store.emitter)(function($$new3) {
              return function __do4() {
                var prevDerived = read(prevRef)();
                var newDerived = v.select($$new3);
                var $83 = v.eq(prevDerived)(newDerived);
                if ($83) {
                  return Nothing.value;
                }
                ;
                liftEffect4(write(newDerived)(prevRef))();
                return new Just(newDerived);
              };
            });
          });
        });
    ...
    return function(initialStore2) {
      return function(reducer) {
        return function(component4) {
          return bind12(liftEffect1(function __do3() {
            var value12 = $$new(initialStore2)();
            var v = create3();
            return {
              value: value12,
              emitter: v.emitter,
            ...
            return pure12({
              hoistedComponent: hoist5(function(v) {
  ...
  var monadStoreHalogenM = function(dictMonadStore) {
    ...
    var lift22 = lift5(MonadEffect0.Monad0());
    var monadEffectHalogenM3 = monadEffectHalogenM(MonadEffect0);
    return {
      getStore: lift22(getStore(dictMonadStore)),
      updateStore: function() {
        var $93 = updateStore(dictMonadStore);
        return function($94) {
          return lift22($93($94));
        };
      }(),
      emitSelected: function() {
        var $95 = emitSelected(dictMonadStore);
        return function($96) {
          return lift22($95($96));
        };
      }(),
      MonadEffect0: function() {
        return monadEffectHalogenM3;
      }
    };
  };
  ...
  var runUI2 = function(component4) {
    return function(i2) {
      return function(element3) {
        return bind15(liftEffect7(map24(toDocument)(bindFlipped7(document)(windowImpl))))(function(document2) {
  ...
  var component = /* @__PURE__ */ function() {
    var handleQuery = function(v) {
      return bind8(get2)(function($$int) {
    ...
    return mkComponent({
      ...
      render: function(v) {
        ...
        })])([text5("I'm the child.")]), text5("I'm rendered within the parent in the component tree, but elsewhere in the DOM.")]);
      },
      "eval": mkEval({
  ...
  var AVar = function() {
    ...
    function drainVar(util, avar) {
      ...
      while (1) {
        ...
        if (value12 === EMPTY && (p2 = takeHead(ps))) {
          avar.value = value12 = p2.value;
        }
        if (value12 !== EMPTY) {
          t = takeHead(ts);
  ...
  var empty8 = /* @__PURE__ */ liftEffect8(empty7);
  ...
  var component2 = function(dictMonadAff) {
    ...
    return function(contextualize) {
      ...
      var $$eval = function(v) {
        if (v instanceof Initialize) {
          return bind9(lift1(contextualize))(function(v1) {
            return bind9(get3)(function(state3) {
              return bind9(liftAff2(empty8))(function($$var2) {
                return bind9(maybe(liftAff2(awaitBody))(pure11)(state3.targetElement))(function(target6) {
                  return bind9(liftAff2(runUI2(hoist4(v1)(state3.child))(state3.input)(target6)))(function(io) {
                    return bind9(liftEffect10(subscribe(io.messages)(function(msg) {
                      return launchAff(put3(msg)($$var2));
                    })))(function() {
                      return bind9(fork(forever2(bind9(liftAff2(take4($$var2)))(function(msg) {
        ...
        if (v instanceof Finalize) {
          return bind9(get3)(function(state3) {
            return discard6(for_3(state3.io)(function($90) {
        ...
        ;
        if (v instanceof Action2) {
          return discard6(raise(v.value0))(function() {
            return pure11(v.value1);
          });
        }
        ;
        if (v instanceof Query) {
          return bind9(gets2(function(v1) {
            ...
            if (v1 instanceof Nothing) {
              return pure11(v.value1(unit));
            }
            ;
            if (v1 instanceof Just) {
              return liftAff2(unCoyoneda(function(k) {
                return function(q2) {
            ...
            ;
            throw new Error("Failed pattern match at Halogen.Portal (line 197, column 13 - line 199, column 89): " + [v1.constructor.name]);
          });
        }
        ;
        throw new Error("Failed pattern match at Halogen.Portal (line 165, column 10 - line 199, column 89): " + [v.constructor.name]);
      };
      return mkComponent({
        initialState,
        render: render2,
    ...
    return function(dictIsSymbol) {
      ...
      return function(dictOrd) {
        ...
        return function(dictMonadAff) {
          ...
          return function(contextualize) {
            return function(label5) {
              return function(slot32) {
                return function(childComponent) {
                  return function(childInput) {
                    return function(htmlElement) {
                      return function(handler3) {
                        return slot22(label5)(slot32)(component1(contextualize))({
  ...
  var map26 = /* @__PURE__ */ map(functorEmitter);
  var innerIsSymbol = {
    reflectSymbol: function() {
      return "inner";
    }
  };
  var slot3 = /* @__PURE__ */ slot()(innerIsSymbol)(ordUnit);
    ...
    return function(selector) {
      return function(action2) {
        return bind10(emitSelected2(selector))(function(emitter) {
          return $$void7(subscribe2(map26(action2)(emitter)));
        });
      };
    };
  };
        ...
        return function(component4) {
          var renderInner = function(input3) {
            return function(context) {
              return slot3($$Proxy.value)(unit)(component4)({
                input: input3,
                context
              })(Raise2.create);
            };
          ...
          var handleAction2 = function(v1) {
            if (v1 instanceof Initialize2) {
              return discard7(subscribe1(v)(Update.create))(function() {
                return bind10(map110(v.select)(getStore2))(function(context) {
            ...
            if (v1 instanceof Receive2) {
              return bind10(gets3(function(v2) {
                ...
                return unless2(unsafeRefEq(oldInput)(v1.value0))(modify_5(function(v2) {
                  var $42 = {};
                  for (var $43 in v2) {
  ...
  var monadEffectStoreT2 = /* @__PURE__ */ monadEffectStoreT(monadEffectAff);
  var monadEffectHalogenM2 = /* @__PURE__ */ monadEffectHalogenM(monadEffectStoreT2);
  var log4 = /* @__PURE__ */ log2(monadEffectHalogenM2);
  var bindFlipped8 = /* @__PURE__ */ bindFlipped(bindHalogenM);
  var traverse_8 = /* @__PURE__ */ traverse_(applicativeHalogenM)(foldableMaybe);
  var logShow3 = /* @__PURE__ */ logShow2(monadEffectHalogenM2)(showInt);
  var childIsSymbol = {
    reflectSymbol: function() {
      return "child";
    }
  ...
  var handleAction = function(action2) {
    return discard8(log4("clicked"))(function() {
      return bindFlipped8(traverse_8(logShow3))(request2(_child)(unit)(GetCount.create));
    });
  };
  var render = function(dictMonadAff) {
    var portalAff1 = portalAff2(dictMonadAff);
    return function(v) {
      return div2([])([text5("I'm the parent"), portalAff1(_child)(unit)(component)(unit)(new Just(v.elem))(HandleChild.create)]);
    };
  };
  var component3 = /* @__PURE__ */ function() {
    return connect(monadEffectStoreT2)(monadStoreStoreT(monadEffectAff))(selectAll)(mkComponent({
      initialState: function(v) {
        return v.input;
      },
      render: render(monadAffStoreT(monadAffAff)),
      "eval": mkEval({
        handleAction,
  ...
  var initialStore = unit;
  var main2 = function __do2() {
    var w = windowImpl();
    var d = document(w)();
    var maybe_elem = getElementById("portal")(toNonElementParentNode(d))();
    var e2 = join3(map28(fromElement)(maybe_elem));
    return runHalogenAff(bind16(awaitBody)(function(body2) {
      return bind16(runStoreT2(initialStore)(reduce)(component3))(function(v) {
        if (e2 instanceof Nothing) {
          return liftEffect9(error5("portal elem not found"));
        }
        ;
        if (e2 instanceof Just) {
          return $$void8(runUI2(v.hoistedComponent)({
            elem: e2.value0
          })(body2));
        }
        ;
        throw new Error("Failed pattern match at Main (line 45, column 5 - line 47, column 55): " + [e2.constructor.name]);
      });
    }))();
  };
