...
(()=>{
                            ...
                            function go2(bot, top2) {
                                switch(top2 - bot){
                                    ...
                                    default:
                                        ...
                                        return apply2(map27(concat2)(go2(bot, pivot)))(go2(pivot, top2));
                                }
                            }
    ...
    var foldFree = function(dictMonadRec) {
        ...
        return function(k) {
            var go2 = function(f) {
                var v = toView(f);
                if (v instanceof Return) return map112(Done.create)(pure15(v.value0));
    ...
    var hoistSlot = function(dictFunctor) {
        return function(nat) {
            return function(v) {
                if (v instanceof ComponentSlot) return unComponentSlot(function(slot4) {
        ...
        return function(dictIsSymbol) {
            ...
            return function(dictOrd) {
                ...
                return function(slot4) {
                    return function(label5) {
                        return function(req) {
                            return query22(slot4)(label5)(req(identity8));
                        };
                    };
                };
            };
        ...
        return function(initialStore2) {
            return function(reducer) {
                return function(component5) {
                    return bind12(liftEffect4(function __do2() {
            ...
            return function(reducer) {
                return function(component5) {
                    return map17(function(v) {
                        return v.component;
                    })(runAndEmitStoreT1(initialStore2)(reducer)(component5));
                };
            };
        };
    };
    ...
    var queueOrRun = function(ref2) {
        return function(au) {
            return bind13(liftEffect5(read(ref2)))(function(v) {
                ...
                if (v instanceof Just) return liftEffect5(write(new Just(new Cons(au, v.value0)))(ref2));
        ...
        return function(initRef) {
            return function(v) {
                ...
                var go2 = function(ref2) {
                    return function(v1) {
                        if (v1 instanceof State) return bind13(liftEffect5(read(ref2)))(function(v2) {
                        ...
                        if (v1 instanceof Subscribe) return bind13(fresh(SubscriptionId)(ref2))(function(sid) {
                        ...
                        if (v1 instanceof Raise) return bind13(liftEffect5(read(ref2)))(function(v2) {
                        ...
                        if (v1 instanceof Fork) return bind13(fresh(ForkId)(ref2))(function(fid) {
                            return bind13(liftEffect5(read(ref2)))(function(v2) {
                        ...
                        if (v1 instanceof Join) return bind13(liftEffect5(read(ref2)))(function(v2) {
                        ...
                        if (v1 instanceof Kill) return bind13(liftEffect5(read(ref2)))(function(v2) {
                            return bind13(liftEffect5(read(v2.forks)))(function(forkMap) {
                        ...
                        if (v1 instanceof GetRef) return bind13(liftEffect5(read(ref2)))(function(v2) {
    ...
    var evalF = function(render2) {
        return function(ref2) {
            return function(v) {
                if (v instanceof RefUpdate) return liftEffect5(flip(modify_)(ref2)(mapDriverState(function(st) {
                    return {
                ...
                if (v instanceof Action) return bind13(liftEffect5(read(ref2)))(function(v1) {
            ...
            return function(document2) {
                ...
                var buildWidget2 = function(spec) {
                    ...
                    var $lazy_render = $runtime_lazy8("render", "Halogen.VDom.Driver", function() {
                        return function(slot4) {
                            if (slot4 instanceof ComponentSlot) return $lazy_renderComponentSlot(86)(slot4.value0);
                            if (slot4 instanceof ThunkSlot) {
    ...
    var component2 = function(dictMonadAff) {
        var MonadEffect0 = dictMonadAff.MonadEffect0();
        var lift32 = lift22(MonadEffect0.Monad0());
        ...
        return function(contextualize) {
            ...
            var $$eval = function(v) {
                if (v instanceof Initialize) return bind8(lift32(contextualize))(function(v1) {
                        ...
                        return bind8(liftAff2(empty8))(function($$var2) {
                            return bind8(maybe(liftAff2(awaitBody))(pure11)(state3.targetElement))(function(target6) {
                                return bind8(liftAff2(runUI2(hoist4(v1)(state3.child))(state3.input)(target6)))(function(io) {
                                    return bind8(liftEffect9(subscribe(io.messages)(function(msg) {
    ...
    var subscribe3 = function(dictMonadStore) {
        ...
        return function(selector) {
            return function(action2) {
                return bind9(emitSelected2(selector))(function(emitter) {
                ...
                return function(component5) {
                    var renderInner = function(input3) {
                        return function(context) {
                            return slot3($$Proxy.value)(unit)(component5)({
                                input: input3,
                                context
                            })(Raise2.create);
                        };
                    ...
                    var render2 = function(state3) {
                        if (state3.context instanceof Just) return renderInner(state3.input)(state3.context.value0);
                        return text5("");
                    };
                    ...
                    var handleAction2 = function(v1) {
                        if (v1 instanceof Initialize2) return discard7(subscribe1(v)(Update.create))(function() {
                            return bind9(map111(v.select)(getStore2))(function(context) {
                                return modify_5(function(v2) {
                                    var $39 = {};
                                    for(var $40 in v2)if (({}).hasOwnProperty.call(v2, $40)) $39[$40] = v2[$40];
                                    $39.context = new Just(context);
                                    return $39;
                                });
                            });
                        });
                        if (v1 instanceof Receive2) return bind9(gets3(function(v2) {
                            return v2.input;
                        }))(function(oldInput) {
                            return unless3(unsafeRefEq(oldInput)(v1.value0))(modify_5(function(v2) {
                                var $42 = {};
                                for(var $43 in v2)if (({}).hasOwnProperty.call(v2, $43)) $42[$43] = v2[$43];
                                $42.input = v1.value0;
                                return $42;
                            }));
                        });
                        if (v1 instanceof Update) return bind9(gets3(function(v2) {
                            return v2.context;
                        }))(function(v2) {
                            if (v2 instanceof Just && unsafeRefEq(v2.value0)(v1.value0)) return pure14(unit);
                            return modify_5(function(v3) {
                                var $48 = {};
                                for(var $49 in v3)if (({}).hasOwnProperty.call(v3, $49)) $48[$49] = v3[$49];
                                $48.context = new Just(v1.value0);
                                return $48;
                            });
                        });
                        if (v1 instanceof Raise2) return raise(v1.value0);
                        throw new Error("Failed pattern match at Halogen.Store.Connect (line 74, column 18 - line 91, column 21): " + [
                            v1.constructor.name
                        ]);
                    };
                    return mkComponent({
    ...
    var handleAction = function(dictMonadStore) {
        var monadEffectHalogenM2 = monadEffectHalogenM(dictMonadStore.MonadEffect0());
    ...
    var component3 = function(dictMonadStore) {
        var handleAction1 = handleAction(dictMonadStore);
        return function(dictMonadAff) {
            return connect(dictMonadAff.MonadEffect0())(dictMonadStore)(selectAll)(mkComponent({
    ...
    var component4 = /* @__PURE__ */ component3(/* @__PURE__ */ monadStoreStoreT(monadEffectAff))(/* @__PURE__ */ monadAffStoreT(monadAffAff));
    ...
    var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind10(awaitBody)(function(body2) {
        return bind10(runStoreT2(initialStore)(reduce)(component4))(function(root) {
            return runUI2(root)(unit)(body2);
        });
    }));
    // <stdin>
    main2();
...
//# sourceMappingURL=index.f019e09c.js.map
